...
libcoveofds gjtoj --outputmetafilename tests/fixtures/geojson_to_json/no_featuretype_1.meta.expected.json  tests/fixtures/geojson_to_json/no_featuretype_1.nodes.geo.json tests/fixtures/geojson_to_json/no_featuretype_1.spans.geo.json  tests/fixtures/geojson_to_json/no_featuretype_1.expected.json
...
libcoveofds jsv  tests/fixtures/jsonschemavalidate/bad_additional_properties_1.input.json > tests/fixtures/jsonschemavalidate/bad_additional_properties_1.expected.json
